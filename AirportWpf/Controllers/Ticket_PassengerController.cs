...
{
    public class Ticket_PassengerController
    {
        ...
        /// </returns>
        public bool CheckAddTicket(string numberTicket, string price)
        {
        ...
        /// <param name="price">Цена билета</param>
        public void AddTicket(string numberTicket, int idFlight, int idPassenger, int price)
        {
