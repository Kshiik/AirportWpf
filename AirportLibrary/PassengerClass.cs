...
namespace AirportLibrary
{
    public class PassengerClass
    {
        ...
        /// <param name="dateOfIssuePassport">Дата выдачи паспорта.</param>
        /// <returns>
        public static void AddPassenger(string firstName, string lastName, string patronymic, DateTime dateOfBirth, string numberPasport, string placeOfIssuePassport, DateTime dateOfIssuePassport)
        {
