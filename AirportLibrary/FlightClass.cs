...
namespace AirportLibrary
{
    public class FlightClass
    {
        ...
        /// </returns>
        public static bool CheckAddFlight(int idAirline, int idDepartureAirport, int idArrivalAirport, string totalNumberOfSeats, string numberOfAvailableSeats, DateTime? departureDate, string departureTime)
        {
            if (idAirline == -1)
        ...
        /// <param name="departureDate">Дата отправления</param>
        /// <param name="departureTime">Время отправления</param>
        public static void AddFlight(int idAirline, int idDepartureAirport, int idArrivalAirport, int totalNumberOfSeats, int numberOfAvailableSeats, DateTime? departureDate, TimeSpan departureTime)
        {
